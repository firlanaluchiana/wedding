            ...
            <div class="container">
                ...
                <div class="couple-wrap animate-box">
                    <div class="couple-half">
                        <div class="groom">
                            <img src="{{ asset('tehome/images/hinata.jpg') }}" alt="Hinata Hyuga" class="img-responsive">
                        </div>
                    ...
                    <div class="couple-half">
                        <div class="bride">
                            <img src="{{ asset('tehome/images/naruto.jpg') }}" alt="Naruto Uzumaki" class="img-responsive">
                        </div>
